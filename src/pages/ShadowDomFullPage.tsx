...
const shadowCSS = `
  ...
  .is-product-card {
    ...
    border-radius: 0;
    overflow: hidden;
    box-shadow: 0 1px 4px color-mix(in srgb, var(--color-text) 80%, transparent), 0 0 0 1px color-mix(in srgb, var(--color-text) 40%, transparent);
  ...
  .is-product-card:hover {
    ...
    box-shadow: 0 12px 28px color-mix(in srgb, var(--color-accent) 12%, transparent), 0 0 0 1px color-mix(in srgb, var(--color-accent) 8%, transparent);
  }
  .is-card-image {
    position: relative;
    aspect-ratio: 1;
  ...
  .is-card-badge {
    ...
    background: linear-gradient(135deg,var(--color-accent-2-600),var(--color-accent-2-700));
    color: var(--color-surface-raised); padding: 4px 10px; border-radius: 0;
  ...
  .is-card-title { font-size: .9375rem; font-weight: 600; color: var(--color-text); margin: 0; line-height: 1.35; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
  ...
  .shadow-dom-header {
    background: linear-gradient(135deg, var(--color-sky-900) 0%, var(--color-sky-800) 50%, var(--color-sky-600) 100%);
  ...
  .shadow-dom-header::after {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at 70% 40%, color-mix(in srgb, var(--color-surface-raised) 8%, transparent) 0%, transparent 60%);
  }
  ...
  .shadow-dom-header p {
    color: color-mix(in srgb, var(--color-surface-raised) 80%, transparent);
    font-size: 0.9375rem;
    margin: 0;
    position: relative;
    z-index: 1;
