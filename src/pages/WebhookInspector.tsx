    ...
    const loadRequests = async (showSpinner: boolean) => {
      ...
      try {
        ...
        setPayload({
          ...
          captureUrl: nextPayload.captureUrl || buildWebhookCaptureUrl(token),
        })
          ...
          <div style={{ display: 'grid', gap: 18 }}>
            <div>
              ...
              <p style={{ margin: '12px 0 0', maxWidth: 900, color: 'var(--color-text-secondary)' }}>
                Send payloads to the API on port `3300`. This UI on port `3000` polls the inspector
                endpoint and shows every captured request plus the response body returned by the API.
              </p>
            </div>
