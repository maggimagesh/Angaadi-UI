...
export default function ShadowDomPage() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { root: scrollWrap, rootMargin: '300px' }
    )
  ...
  return (
    <main className="app-main shadow-dom-page">
      <div className="shadow-dom-header">
        <h1>Shadow DOM — Infinite Scroll</h1>
        <p>Product cards are rendered inside an encapsulated Shadow DOM</p>
      </div>
      <div className="shadow-dom-container">
        <div className="shadow-host" ref={hostRef} />
      </div>
    </main>
  )
}
